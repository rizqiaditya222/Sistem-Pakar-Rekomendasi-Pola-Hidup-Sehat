...
% Aturan rekomendasi makanan (diperkaya)
...
% Aturan rekomendasi olahraga (diperkaya)
...
    % Bersihkan fakta dinamis sebelumnya
    retractall(usia(_)),
